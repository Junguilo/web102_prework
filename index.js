...
function addGamesToPage(games) {
    ...
    for(let i = 0; i < games.length; i++){
        ...
        <p><strong> Goal:</strong> $${games[i].goal.toLocaleString('en-US')}</p>
        <p><strong> Pledged:</strong> $${games[i].pledged.toLocaleString('en-US')}</p>
        <p><strong> Backers:</strong> ${games[i].backers.toLocaleString('en-US')}</p>
        `;
